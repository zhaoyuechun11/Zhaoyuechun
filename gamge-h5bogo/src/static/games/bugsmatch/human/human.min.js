!function (t) {
    ...
    i(4), i(9), i(5), i(6), i(8), i(7), i(10), i(11), i(12), i(13), i(14), i(1), i(2), i(3)
}, function (t, e) {
    PIXI.Container.prototype.setTouchStartAction = function (t, e, i) {
        t.mousedown = t.touchstart = function (n) {
            n.stopPropagation(), GD.fullScreen(), GD.buttonAction(t), e && e.call(i, n)
        }.bind(i)
    ...
    GD.CommonIntro = function (t, e) {
        ...
        GamePadManager.init(), GamePadManager.isConnected && GD.isShowPadGuide && (this.gamePadGuide || (this.gamePadGuide = new GD.GamePadGuide), this.showGamePadGuide(), this.addGamePadEvent()), GD.isShowPadGuide = !1, this.setInteractive(!0)
        ...
        this.helpBtn = this.setSpriteTexture(this.helpBtn, "texture", t), this.helpBtn.anchor.set(.5), this.helpBtn.x = e, this.helpBtn.y = i, this.helpBtn.scale.set(1), this.addChild(this.helpBtn), this.setTouchStartAction(this.helpBtn), this.setTouchEnd(this.helpBtn, this.showHelp, this)
    ...
    GD.CommonOption = function (t) {
        PIXI.Container.call(this), this.scorePopup = new GD.ScorePopup, this.scorePopup.on("SCORE_POPUP_CLOSE_EVENT", this.closeScorePopup.bind(this)), this.optionPopup = new GD.OptionPopup, this.optionPopup.on("SOUND_POPUP_CLOSE_EVENT", this.closeOptionPopup.bind(this)), this.optionPopup.on("TUTORIAL_OPEN_EVENT", this.showTutorial.bind(this)), this.optBtn = this.setSpriteTexture(this.optBtn, "texture", "btn_option_" + t), this.optBtn.anchor.set(.5), this.optBtn.x = GD.width - 40, this.optBtn.y = 40, this.setTouchStartAction(this.optBtn), this.setTouchEnd(this.optBtn, function () {
            this.setInteractive(!1), this.emit("OPTION_OPEN_EVENT"), this.optionPopup.show(1), this.addChild(this.optionPopup)
        ...
        GD.renderer.view.style.display = "inline", this.emit("GAME_RESTART")
    ...
    GD = {
        ...
        if (GD.width = t, GD.height = e, GD.leng = gamen.game_language, navigator.userAgent.match(/Android 4./) || navigator.userAgent.match(/TG-L800S/) ? this.renderer = PIXI.autoDetectRenderer(t, e, {backgroundColor: o}) : this.renderer = PIXI.autoDetectRenderer(t, e, {
            backgroundColor: o,
            resolution: 2,
            clearBeforeRender: !1
        }), $("#gamecontainer")[0] ? ($("#gameCanvas") && $("#gameCanvas").remove(), $("#gamecontainer").append(this.renderer.view)) : document.body.appendChild(this.renderer.view), GD.Util.mobileCheck() && (GD.isMobile = !0), GD.Util.mobileCheck()) {
            var s = navigator.userAgent.toLowerCase();
            -1 != s.indexOf("android 4.") ? -1 == s.indexOf("chrome") && -1 == s.indexOf("mobile safari") || (GD.soundType = 1) : GD.soundType = 1
        } else GD.soundType = 1;
        requestAnimationFrame(this.update), this.root = new PIXI.Container, this.stage = new PIXI.Container, this.root.addChild(this.stage), GD.isDebug && (GD.stats = new Stats, document.body.appendChild(GD.stats.domElement), GD.stats.domElement.style.position = "absolute", GD.stats.domElement.style.top = "0px"), this.resize(), this.setSpriteTexture(), this.resourceLoad()
        ...
        if (GD.renderer) {
            ...
            } else n > t ? e = i * t : i = e / t, this.renderer.view.style.width = e + "px", this.renderer.view.style.height = i + "px", this.renderer.view.style.margin = "auto",
                this.renderer.view.style.position = "absolute",
                this.renderer.view.style.top = 0,
                this.renderer.view.style.bottom = 0,
                this.renderer.view.style.right = 0,
                this.renderer.view.style.left = 0,
                this.renderer.view.style.backgroundColor = "#996105"
        }
        ...
        // if (GD.isMobile) {
        //     var t = navigator.platform.match(/iPhone|iPod|iPad/);
        //     t || (document.exitFullscreen ? document.exitFullscreen() : document.msExitFullscreen ? document.msExitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitCancelFullScreen && document.webkitCancelFullScreen())
        // }
    ...
    DataManager = {}, DataManager.unique = null, DataManager.pk = null, DataManager.Skey = null, DataManager.Okey = null, DataManager.callFunc = null, DataManager.target = null, DataManager.playInterval = null, DataManager.start = function (t, e) {
        DataManager.callFunc = t, DataManager.target = e, gamen.start(DataManager.startDataComplete)
        ...
        if (DataManager.playInterval && clearInterval(DataManager.playInterval), GD.isLogin) {
            ...
            var o = XORcipher().xorEncoder(t.toString(), GD.sKey),
                s = GD.commonOption.gameRestart.bind(GD.commonOption), r = XORcipher().xorEncoder(GD.unique, GD.sKey),
    ...
    GD.Tutorial = function () {
        ...
        }, this), this.addChild(this.prevBtn), this.nextBtn = this.setSpriteTexture(this.nextBtn, "texture", "temp"), this.nextBtn.anchor.set(.5), this.nextBtn.x = GD.width - 30, this.nextBtn.y = GD.height / 2, this.setTouchStartAction(this.nextBtn, function () {
            this.nowPage + 1 < this.totalPage && this.initPage(this.nowPage + 1)
        }, this), this.addChild(this.nextBtn), this.closeBtn = this.setSpriteTexture(this.closeBtn, "texture", "temp"), this.closeBtn.anchor.set(.5), this.closeBtn.x = GD.width / 2, this.closeBtn.y = GD.height - 105, this.setTouchStartAction(this.closeBtn), this.setTouchEnd(this.closeBtn, function () {
        ...
        this.totalPage > 1 && (this.prevBtn = this.setSpriteTexture(this.prevBtn, "texture", "help_prev"), this.nextBtn = this.setSpriteTexture(this.nextBtn, "texture", "help_next"), this.prevBtn.scale.set(1), this.nextBtn.scale.set(1), this.addChild(this.prevBtn), this.addChild(this.nextBtn))
