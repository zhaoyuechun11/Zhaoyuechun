...
var jsArr = [
    ...
    GAME_JS_PATH + './MoMoBakery/js/core/GC.js',
    GAME_JS_PATH + './MoMoBakery/js/core/MovieClip.js',
    GAME_JS_PATH + './MoMoBakery/js/core/NumberText.js',
    GAME_JS_PATH + './MoMoBakery/js/play/GameScene.js',
    GAME_JS_PATH + './MoMoBakery/js/main.js'
];
