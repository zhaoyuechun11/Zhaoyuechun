<template>
    <f7-page name="gameResult" style="background: #252525">
        ...
        <f7-block style="padding: 10px 35px;padding-bottom: 0px;margin-bottom: 0px">
            <f7-row strong>
                <f7-col width="25" style="background: transparent">
                    <div style="width: 100%; padding-top: 100%; position: relative">
                        <score-view  class="pk-head" style="border:0px solid white;background: transparent;width: 100%; height: 100%;position: absolute;top: 0;left: 0;" :innerImgUrl="leftUserHead" :outerImgUrl="leftHeadPortraitFrame" />
                    </div>
                    <p style="margin-top: 8px;color: #FFFFFF;width: 60px;">{{leftUserName}}</p>
                </f7-col>
                <f7-col width="50" style="background: transparent">
                    <f7-row>
                        <f7-col width="40" style="background: transparent">
                            <p style="font-size: x-large; color: #FFFFFF">{{leftScore}}</p>
                        </f7-col>
                        <f7-col width="10" style="background: transparent">
                            <p style="font-size: x-large; color: #FFFFFF">:</p>
                        </f7-col>
                        <f7-col width="40" style="background: transparent">
                            <p  style="font-size: x-large;color: #FFFFFF">{{rightScore}}</p>
                        </f7-col>
                    </f7-row>
                </f7-col>
                <f7-col width="25" style="background: transparent">
                    <div style="width: 100%; padding-top: 100%; position: relative">
                        <score-view  class="pk-head" style="border:0px solid white;background: transparent;width: 100%; height: 100%;position: absolute;top: 0;left: 0;" :innerImgUrl="rightUserHead" :outerImgUrl="rightHeadPortraitFrame" />
                    </div>
                    <p style="margin-top: 8px;color: #FFFFFF;width: 60px;text-transform:capitalize;text-align: center" class="single-line">{{rightUserName}}</p>
                </f7-col>
            </f7-row>
        </f7-block>
