<template>
  <div class="d-roll-wrapper">
    ...
    >
      ...
      <span class="d-roll-item" style="padding-left: 8px;">PLAY</span>
    </ul>
  </div>
</template>

<script>
import { Tween, easeToCubicMap, arrayFromCache, getHeight, supportCssCache, callExp } from '../../utils';
...
export default {
  ...
  data() {
    ...
    const divList = arrayFromCache(10).map((n, i) => `<div style="align-content: center">${i}</div>`);
