                        ...
                        if (orientationGuide = GD.orientationGuide, null == orientationGuide) {
                            if (
                                ...
                                switch (GD.lang) {
                                    ...
                                    default:
                                        txt = window.innerWidth > 480 ? "If the screen does not switch, turn on the auto rotate function." : "If the screen does not switch,<br>turn on the auto rotate function."
                                }
        ...
        GD.Progress = function () {
            ...
            GD.Progress.prototype.show = function () {
                this.bg = new PIXI.Graphics,
                    ...
                    this.bg.endFill(),
                    this.addChild(this.bg);
                this.zhuye002  = new PIXI.Sprite.fromImage("human/image/zhuye002.png"),
                    this.zhuye002.x = GD.width / 2,
                    this.zhuye002.y = GD.height / 2,
            ...
            GD.Progress.prototype.showLocoText = function () {
                TweenMax.to(this.zhuye002, 0.2, {
                    x: GD.width/2 + 50, ease: Sine.easeIn
                });

                this.loading02  = new PIXI.Sprite.fromImage("human/image/loading02.png"),
                    this.loading02.x = GD.width / 2 -70,
                    this.loading02.y = GD.height / 2 - 20,
