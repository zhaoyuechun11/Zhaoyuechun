window.skins={};
	...
	function game() {
		_super.call(this);
		this.skinParts = ["bg","light0","light1","light2","light3","light4","light5","light6","light7","light8","light9","light10","light11","light12","light13","light14","light15","light16","light17","light18","light19","lightgroup","b0","b1","b2","b7","b3","b6","b5","b4","clickone","clickten","clickblock","di1","di2","desc","scrolgroup","toptxt1","toptxt2","topgroup","goldimg","golddesc","goldtxt","xialabg","goldtxt1","goldtxt2","goldtxt3","goldimg1","goldimg2","goldimg3","xialagroup","confirmbtn","pricegroup","singleprice","overgroup"];
		
		this.height = 1920;
		this.width = 1080;
		this.elementsContent = [this._Image1_i(),this.bg_i(),this._Image2_i(),this.lightgroup_i(),this._Group1_i(),this._Image5_i(),this._Image6_i(),this.di1_i(),this.di2_i(),this.scrolgroup_i(),this.topgroup_i(),this._Image8_i(),this._Image9_i(),this._Image10_i(),this.goldimg_i(),this.golddesc_i(),this.goldtxt_i(),this.xialagroup_i(),this.overgroup_i()];
	}
