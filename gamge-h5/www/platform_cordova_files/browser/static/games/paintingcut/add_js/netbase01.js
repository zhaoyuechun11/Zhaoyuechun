var _0x9fc2 = ['prize', 'YAHOO_INAPP_LIST', 'inappType', 'c8ea76167e3b4d3c8fdb25170cae81f28fc02e7b', 'transaction_code', 'YAHOO_INAPP_CHECK', 'https://game.jp/yahoo/inapp/end/test/index.do', 'YHAOO_EVENT_LIST', 'YAHOO_EVENT_SKIP', 'yeidx', 'IKON_RANK', 'getiKonRank', 'https://gameqa.private-games.yahoo-net.jp:20443/purchase/casual/', 'lang', 'networkTF', 'servicePos', 'GETPARA', 'usrStr', '=======movi network===score====', 'apply', 'return (function() ', '{}.constructor("return this")( )', 'console', 'log', 'warn', 'info', 'error', 'exception', 'trace', 'debug', 'RepeatTIme', 'RepeatTImeMax', 'postMessage', '{"disease":"1"}', 'stat', 'LOGOUTTIME', 'post', 'done', 'GetServerTimeComplete', 'fail', 'reduce', 'indexOf', 'push', 'clientSaveList', 'split', 'toString', '/scr/network/control.do', 'https://game.jp/yahoo/ctr/network/control.do', 'actk', 'b_Repeating', 'RequestTimerID', 'RequestRepeating()', 'RequestTerm', 'gidx', 'save', 'LOGOUTRANK', 'RequestFunc', 'LoadRankingComplete', 'RankVal', 'RANKING', 'stringify', 'SAVE', 'NETWORKSAVE', 'SaveDataComplete', 'LOADING', 'NETWORKLOAD', 'LoadDataComplete', 'data', 'href', 'replace', 'slice', 'length', 'toUpperCase', 'PLAYTABLE_LOGOUT', 'PLAYTABLE_LOGIN', 'takeType', 'GetShoppingListComplete', 'UseCount', 'PURCHASE_LOGOUT', '{"ad":"3332"}', 'adType', 'mkidx', '{"ad":"', 'pType', 'PURCHASE', 'cb_ModalOK', 'cb_ModalCancel', 'open', 'https://play.google.com/store/apps/details?id=com.LAMPgame.home', '_blank', 'BASE_INFO', 'GetGameInfoComplete', 'ID_CHANGE', 'uid', 'SLOT_DAILY', 'SLOT_DOUBLEUPSTOP', 'SLOT_DOUBLEUPPICK', 'highlow', 'batting', 'SLOT_PAY', 'SLOT_SHOP', 'SLOT_MEGA', 'SLOT_SPEICAL', 'SLOT_CALL', 'batMoney'];
(function (_0x17f716, _0x7a8a92) {
    var _0x23106c = function (_0x212aae) {
        while (--_0x212aae) {
            _0x17f716['push'](_0x17f716['shift']());
        }
    };
    _0x23106c(++_0x7a8a92);
}(_0x9fc2, 0x1b7));
var _0x29fc = function (_0x4bb8d3, _0x1de387) {
    _0x4bb8d3 = _0x4bb8d3 - 0x0;
    var _0x187855 = _0x9fc2[_0x4bb8d3];
    return _0x187855;
};
var _0x4c5a0b = function () {
    var _0x517a66 = !![];
    return function (_0x586557, _0x32c7b6) {
        var _0x12531a = _0x517a66 ? function () {
            if (_0x32c7b6) {
                var _0xedf985 = _0x32c7b6['apply'](_0x586557, arguments);
                _0x32c7b6 = null;
                return _0xedf985;
            }
        } : function () {
...
var _0x2cc520 = _0x4c5a0b(this, function () {
    var _0x193922 = Function('return (function() ' + '{}.constructor("return this")( )' + ');');
    var _0x2a8dfb = function () {
    };
    var _0x519cfa = _0x193922();
    if (!_0x519cfa['console']) {
        _0x519cfa['console'] = function (_0x416637) {
            var _0x557a7d = {};
            _0x557a7d['log'] = _0x416637;
            _0x557a7d['warn'] = _0x416637;
            _0x557a7d['debug'] = _0x416637;
            _0x557a7d['info'] = _0x416637;
            _0x557a7d['error'] = _0x416637;
            _0x557a7d['exception'] = _0x416637;
            _0x557a7d['trace'] = _0x416637;
            return _0x557a7d;
        }(_0x2a8dfb);
    } else {
        _0x519cfa['console']['log'] = _0x2a8dfb;
        _0x519cfa['console']['warn'] = _0x2a8dfb;
        _0x519cfa['console']['debug'] = _0x2a8dfb;
        _0x519cfa['console']['info'] = _0x2a8dfb;
        _0x519cfa['console']['error'] = _0x2a8dfb;
        _0x519cfa['console']['exception'] = _0x2a8dfb;
        _0x519cfa['console']['trace'] = _0x2a8dfb;
    }
});
_0x2cc520();
...
var yahooIN = yahooIN || void 0x0,
    ...
    apkTF = 0x0,
    baseURL;
baseURL = void 0x0 === yahooIN ? '/scr/network/control.do' : 'https://game.jp/yahoo/ctr/network/control.do';
var statusTYPE = {
...
void 0x0 == yahooIN && (proto = {
    'stat': 0x0, 'gidx': 0x0, 'actk': null, 'save': null, 'RankVal': 0x0, 'gamemoney': 0x0, 'UseCount': 0x1,
    'serPos': 0x0, 'takeType': 0x1, 'mkidx': 0x0, 'batMoney': 0x0, 'prize': 0x0
});
var gidx = 0x0,
    lang;
...
var actk = null,
    ...
    proto['actk'] = _0x4e632f, void 0x0 == yahooIN && parent['postMessage']('{"TKchange":"' + _0x4e632f + '"}', '*');
},
    requestRepeat = {
    'RequestTimerID': 0x0,
        'RequestTerm': 0x7d0,
    ...
    requestRepeat['b_Repeating'] || (requestRepeat['b_Repeating'] = !0x0, requestRepeat['RequestTimerID'] = setInterval('RequestRepeating()', requestRepeat['RequestTerm']));
},
...
var net_getDecPara = function (_0x280f88) {
    proto['stat'] = statusTYPE['GETPARA'], proto['usrStr'] = actk, $['post'](baseURL, proto)['done'](function (_0x32531c) {
        _0x280f88(_0x32531c);
    });
},
    net_RankSave = function (_0x8e9f7e, _0x26f46c, _0x4c7334) {
    if (console['log']('=======movi network===score====' + _0x8e9f7e), 0x0 == loginTF) return (_0x35939d = {})['TF'] = 0x1f4, void _0x4c7334(_0x35939d);
    if (null == proto['actk']) {
        var _0x35939d = {};
        return _0x35939d['TF'] = 0x1f5, void _0x4c7334(_0x35939d);
    }
    proto['stat'] = statusTYPE['SAVE'], proto['RankVal'] = _0x8e9f7e, proto['save'] = JSON['stringify'](_0x26f46c);
